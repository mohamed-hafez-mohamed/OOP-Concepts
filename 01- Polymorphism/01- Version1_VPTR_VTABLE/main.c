...
int main(void)
{
   ...
   Local_u16RectangleArea = (u16)SHAPE_AREA_VCALL((Shape_t *)&Local_RectangleObject);
   printf("Rectangle Area = %d\n",  Local_u16RectangleArea);
   Local_u16CircleArea    = (u16)SHAPE_AREA_VCALL((Shape_t *)&Local_CircleObject);
   printf("Circle    Area = %d\n",  Local_u16CircleArea);
   SHAPE_voidDrawShapes(Rom_ShapeObjects);
   return 0;
}
